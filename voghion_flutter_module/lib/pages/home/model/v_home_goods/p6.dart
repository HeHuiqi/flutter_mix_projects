...
class P6 {
  ...
  factory P6.fromMap(Map<String, dynamic> data) => P6(
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [P6].
  factory P6.fromJson(String data) {
    return P6.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [P6] to a JSON string.
